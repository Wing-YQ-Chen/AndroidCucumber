def openpyxl_merge_cell(sheet_object: Worksheet, start_cell: Cell, resize_y: int = 0, resize_x: int = 0):
    ...
    sheet_object.merge_cells(start_row=start_cell.row, start_column=start_cell.column, end_column=end_column, end_row=end_row)
...
def set_value_to_range(xl_workbook, sheet, start_cell_coordinate, value, highlight=None, red_keyword_list: list = [], green_keyword_list=[]):
    """
